...
export function Header() {
    ...
    <div data-src="images/home/slide-1.jpg">
        ...
        animated p-bg-color button-one " data-wow-delay="0.3s">
                ...
                <div className="wow fadeInRight animated image-shape-one" data-wow-delay="0.33s">
                    <svg version="1.1" className="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g clipPath="url(#shape-one)">
                            <image width="750" height="576" href="images/carousel/carousel-1.png"
                ...
                <div className="wow fadeInRight animated image-shape-two" data-wow-delay="0.39s">
                    <div className="theme-shape-two"> </div>
                </div>
            </div>
        </div>
    </div>
        ...
        animated p-bg-color button-one " data-wow-delay="0.3s">
                ...
                <div className="wow fadeInRight animated image-shape-one" data-wow-delay="0.33s">
                    <svg version="1.1" className="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g clipPath="url(#shape-one)">
                            <image width="778" height="576" href="images/carousel/carousel-3.1.png"
                                className="banner-img-one">
                            </image>
                        </g>
                    </svg> </div>
