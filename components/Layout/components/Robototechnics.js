                ...
                <div className="row">
                    <div className="col-lg-7 col-md-offset-5">
                        <div className="main-content">
                            <h2>Bo'lajak dasturchilar uchun Robo kids dasturlari
                                bo'lajak ixtirochilarni kashf etadi
                            </h2>
                            <div className="main-wrapper">
                                <h4>Nega Robo kids?</h4>
                                <p>
                                    Robo kids dasturimiz 2ta keng programma Sratch va Robototexnika
                                    kurslarini o’z ichiga olgan bo’lib, bu kurslar davomida
                                    farzandingiz qiziq muammolar yechishni va o’z kichik dasturlar
                                    yasash logikasini o’rganishadi.
                                </p>
                                <p>
                                    Robototexnika esa kelajak texnologiyasi robotlar olamiga sayohat
