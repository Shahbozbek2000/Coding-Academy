        ...
        <div
            ...
            <div className="camera_caption">
                <div className="container">
                    <h5 className="wow fadeInUp animated">English</h5>
                    <h1 className="wow fadeInUp animated" data-wow-delay="0.2s">
                        CAT kurslari studentlarga butun hayoti davomida yuqori
                        darajada dasturchilar bo'lishiga ko'mak beradi
                    </h1>
                    <a href="course-2-column.html" className="tran3s hvr-trim wow fadeInUp
                        animated p-bg-color button-one" data-wow-delay="0.3s">Batafsil</a>
                </div> 
            </div> 
        </div>
        <div
            data-src="https://eduau.com.au/wp-content/uploads/2019/11/Cover-Page-Image-2.jpg">
            <div className="camera_caption">
                <div className="container">
                    <h5 className="wow fadeInUp animated">English</h5>
                    <h1 className="wow fadeInUp animated" data-wow-delay="0.2s">
                    ...
                    <a href="course-2-column.html" className="tran3s hvr-trim wow fadeInUp
                        animated p-bg-color button-one" data-wow-delay="0.3s">Explore Now</a>
                </div> 
            </div> 
        </div>
    </div> 
 ...
 <div className="theme-counter">
            ...
            <div className="row">
                <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                    <div className="single-box">
                        <h2 className="number"><span className="timer" data-from="0" data-to="2730" data-speed="1000" data-refresh-interval="5">0</span>+</h2>
                        <p>Completed Projects</p>
                    </div> 
                </div>
                <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                    <div className="single-box">
                        <h2 className="number"><span className="timer" data-from="0" data-to="39" data-speed="1000" data-refresh-interval="5">0</span></h2>
                        <p>Availble Country</p>
                    </div> 
                </div>
                <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                    <div className="single-box">
                        <h2 className="number"><span className="timer" data-from="0" data-to="125" data-speed="1000" data-refresh-interval="5">0</span>M</h2>
                        <p>User Worldwide</p>
                    </div> 
                </div>
                <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                    <div className="single-box border-fix">
                        <h2 className="number"><span className="timer" data-from="0" data-to="12" data-speed="1000" data-refresh-interval="5">0</span></h2>
                        <p>Award Winner</p>
                    </div> 
                </div>
            </div> 
    ...
    <section id="career-wrapper">
        <div className="container">
            ...
            <p>Unumli ta'lim nafaqat yaxshi o'quv materiallariga bog'liq, Balki
                o'qiyotgan va o'qitayotgan insonlarni bir-biri bilan bog'lashdir.
                2020-yil, Mart oyidan buyon CAT dasturchilar akademiyasi yuqori malakali
                va iqtidorli yoshlarni bir joyga to'plash bilan juda yuqori natijalarga
                erishdi
            </p>
            <div className="row">
                <div className="col-lg-4 col-sm-6 col-md-4 col-xs-12 col-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <p>CAT academiyasi bilan birgalikda,
                                Full stack Web developmentni JavaScript
                                va Typescript orqali qurasiz. Bizning
                                zamonaviy va raqobatdosh o’quv dasturimiz
                                jahonni eng talabgir dasturchilariga
                                aylantiradi. </p>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 col-sm-6 col-md-4 col-xs-12 col-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <p>CAT academiyasi mentorlarni bir nechta
                                mahalliy va halqaro proyektlarda tajriba
                                ortirgan bo’lib, o’quvchilarga nafaqat
                                nazariy bilim balki o’z amaliyotlaridan
                                misollar taqdim etadilar</p>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 col-sm-6 col-md-4 col-xs-12 col-12">
            ...
            <div className="row">
                <div className="col-md-4 col-sm-6 col-xs-12">
                    <div className="single-service">
                        ...
                        <h6><a href="#" className="tran3s">Raqobatdosh bilim</a></h6>
                    </div> 
                </div> 
                <div className="col-md-4 col-sm-6 col-xs-12">
                    <div className="single-service">
                        ...
                        <h6><a href="#" className="tran3s">Jahon yetakchi kompaniyalari
                                <br/>foydalanadigan metodika</a>
                        </h6>
                    </div> 
                </div>
                ...
                <div className="col-md-4 col-sm-6 col-xs-12">
                    <div className="single-service">
                        ...
                        <h6><a href="#" className="tran3s">Proffesional Rezumelar <br/>
                                tayyorlash darslaris</a></h6>
                    </div> 
                </div> 
                <div className="col-md-4 col-sm-6 col-xs-12">
                    <div className="single-service">
                        ...
                        <h6><a href="#" className="tran3s">Koreiara mentorlar
                                ko’magi</a></h6>
                    </div> 
                </div> 
                <div className="col-md-4 col-sm-6 col-xs-12">
                    <div className="single-service">
                        ...
                        <h6><a href="#" className="tran3s">Jahon ish bozoriga
                                qadamlar</a></h6>
                    </div> 
                </div> 
                <div className="col-md-4 col-sm-6 col-xs-12">
                    <div className="single-service">
                        ...
                        <p>SEO &amp; SMM</p>
                        <h6><a href="#" className="tran3s">Suhbatga tayyorgarlik</a></h6>
                    </div> 
                </div> 
            </div> 
        </div> 
                    ...
                    <div className="single-team-member">
                        <div className="image">
                            ...
                            <div className="opacity tran3s">
                                <ul className="tran3s">
                                    <li><a href="" className="tran3s"><i className="fa fa-facebook"
                                                aria-hidden="true"></i></a></li>
                                    <li><a href="" className="tran3s"><i className="fa fa-twitter"
                                                aria-hidden="true"></i></a></li>
                                    <li><a href="" className="tran3s"><i className="fa fa-dribbble"
                                                aria-hidden="true"></i></a></li>
                                    <li><a href="" className="tran3s"><i className="fa fa-google-plus"
                                                aria-hidden="true"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="single-team-member">
                        <div className="image">
                            <img
                                ...
                                style={{height:'350px', objectFit:'cover'}} alt=""/>
                            <div className="opacity tran3s">
                                <ul className="tran3s">
                                    <li><a href="" className="tran3s"><i className="fa fa-facebook"
                                                aria-hidden="true"></i></a></li>
